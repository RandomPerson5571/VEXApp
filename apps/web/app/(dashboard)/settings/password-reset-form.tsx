      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <form action={action} className="shrink-0">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-slate-800 bg-slate-950/60 px-4 py-2 text-xs font-bold text-slate-200 transition hover:border-blue-500/30 hover:bg-blue-500/10 hover:text-blue-200 disabled:cursor-not-allowed disabled:opacity-60"
          >
