...
import {
  INVENTORY_COLOR_PRESETS,
  muteInventoryColor,
} from "@/lib/inventory/item-colors";
        ...
        <div className="relative">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <fieldset className="space-y-2">
              <legend className="block text-[10px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-400">
                Color Code
              </legend>
              <div className="grid grid-cols-4 gap-2">
                {INVENTORY_COLOR_PRESETS.map((preset) => {
              ...
              <label className="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 dark:border-[#1a1a1a] dark:bg-[#121212]">
                ...
                />
                <span
                  className="ml-auto h-5 w-5 rounded-full border border-black/10"
