            ...
            {buildLogsOpen && (
              <div className="pl-3.5 border-l border-slate-900 space-y-2 py-1">
                <div className="space-y-1">
                  ...
                  {seasonOpen && (
                    <div className="pl-4 space-y-0.5 py-0.5 border-l border-slate-900">
      ...
      <div className="flex-1 overflow-y-auto px-10 py-8 bg-[#03070e] text-slate-300 dashboard-scroll">
        ...
        {!hasNotebookEntry ? (
          ...
          <div className="border border-slate-900 bg-[#090e18]/45 p-12 rounded-2xl text-center max-w-2xl mx-auto my-12 shadow-xl select-none">
            ...
            <p className="text-xs text-slate-600 mt-1">
              Select{" "}
              <span className="text-blue-400 font-bold font-mono">&quot;Week 2: Intake Redesign&quot;</span> from
            ...
            <button
              ...
              className="mt-5 px-4 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-xs font-bold text-white shadow-lg shadow-blue-500/10 cursor-pointer"
            >
              Browse Week 2 log
            </button>
          </div>
        ...
        <div className="space-y-1">
          {TABLE_OF_CONTENTS.map((toc) => {
            ...
            return (
              ...
              >
                <div className={`h-1 w-1 rounded-full ${isSelected ? "bg-blue-400" : "bg-slate-600"}`} />
                <span>{toc.label}</span>
              </button>
            );
          })}
