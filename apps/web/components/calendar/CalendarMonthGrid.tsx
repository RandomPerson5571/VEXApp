...
import { getEventStyle } from "@/lib/utils/calendar";
        ...
        {calendarDays.map((cell) => {
          ...
          return (
            <button
              ...
              className={`min-h-[85px] p-2 flex flex-col justify-between transition relative text-xs cursor-pointer select-none group border-slate-200 dark:border-slate-900/60 text-left ${
