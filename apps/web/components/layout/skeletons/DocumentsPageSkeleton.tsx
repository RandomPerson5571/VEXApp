export function DocumentsPageSkeleton() {
  return (
    <div
      ...
      className="flex flex-1 overflow-hidden bg-slate-50 font-sans dark:bg-[#03070e]"
    >
      <aside className="flex h-full w-[250px] flex-col border-r border-slate-200 bg-white p-5 dark:border-slate-900 dark:bg-[#070b13]">
        <div className="mb-4 h-3 w-20 animate-pulse rounded bg-slate-200 dark:bg-slate-900/70" />
      ...
      <div className="flex-1 overflow-y-auto px-10 py-8 dashboard-scroll">
        <div className="mb-6 flex gap-2">
          <div className="h-4 w-16 animate-pulse rounded bg-slate-200 dark:bg-slate-900/70" />
          <div className="h-4 w-24 animate-pulse rounded bg-slate-100 dark:bg-slate-950/60" />
        </div>
      ...
      <aside className="hidden w-[220px] border-l border-slate-200 bg-white p-5 dark:border-slate-900 dark:bg-[#070b13] xl:block">
        <div className="mb-4 h-3 w-24 animate-pulse rounded bg-slate-200 dark:bg-slate-900/70" />
        <div className="space-y-2">
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className="h-4 animate-pulse rounded bg-slate-100 dark:bg-slate-950/70"
            />
          ))}
        </div>
      </aside>
