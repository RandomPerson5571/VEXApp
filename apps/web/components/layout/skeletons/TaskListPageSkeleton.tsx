export function TaskListPageSkeleton() {
  return (
    <div
      ...
      className="relative flex-1 overflow-y-auto bg-slate-50 px-8 py-6 font-sans dashboard-scroll dark:bg-[#03070e]"
    >
      <div className="relative mb-6 space-y-4">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 animate-pulse rounded-xl border border-slate-200 bg-white dark:border-slate-900 dark:bg-slate-950/60" />
          <div className="space-y-2">
            <div className="h-2.5 w-24 animate-pulse rounded bg-blue-600/20" />
            <div className="h-8 w-36 animate-pulse rounded-lg bg-slate-200 dark:bg-slate-900/80" />
          </div>
        </div>
        <div className="h-4 w-full max-w-2xl animate-pulse rounded bg-slate-100 dark:bg-slate-950/70" />
      </div>
