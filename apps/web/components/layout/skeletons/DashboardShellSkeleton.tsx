...
export function DashboardShellSkeleton() {
  return (
    <div className="flex h-dvh max-h-dvh min-h-0 overflow-hidden bg-slate-50 text-slate-900 dark:bg-[#000000] dark:text-slate-100 selection:bg-orange-600/30 selection:text-orange-200">
      <SidebarSkeleton />
