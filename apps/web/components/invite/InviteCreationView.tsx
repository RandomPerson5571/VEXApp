...
const fieldClassName =
  "w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-xs font-semibold text-slate-900 shadow-sm outline-none transition placeholder:text-slate-500 focus:border-blue-500/40 focus:ring-1 focus:ring-blue-500/20 dark:border-[#1a1a1a] dark:bg-[#121212]/80 dark:text-slate-200 dark:placeholder:text-slate-600";
