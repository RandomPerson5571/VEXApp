...
const fieldClassName =
  "w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-xs font-semibold text-slate-900 outline-none transition placeholder:text-slate-500 focus:border-blue-500/40 focus:ring-1 focus:ring-blue-500/20 dark:border-[#1a1a1a] dark:bg-[#121212]/80 dark:text-slate-200 dark:placeholder:text-slate-600";
  ...
  return (
    <div className="flex flex-1 overflow-y-auto bg-slate-50 dashboard-scroll dark:bg-[#000000]">
      <div className="mx-auto flex w-full max-w-xl flex-col gap-6 px-8 py-10">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_24px_80px_-50px_rgba(37,99,235,0.35)] backdrop-blur-sm motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-3 motion-safe:duration-700 motion-reduce:animate-none dark:border-[#1a1a1a] dark:bg-[#0a0a0a]">
              ...
              {isTeamLocked && selectedTeam ? (
                <>
                  <div
                    ...
                    className="relative overflow-hidden rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-3.5 motion-safe:animate-in motion-safe:fade-in motion-safe:duration-300 motion-reduce:animate-none dark:border-slate-800/90 dark:bg-[#121212]/50"
                  >
                    <div
                      aria-hidden="true"
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={!inviteLink}
                  className="inline-flex shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white px-3 text-slate-600 transition hover:border-slate-300 hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-40 motion-safe:hover:scale-[1.02] motion-reduce:transition-none dark:border-[#1a1a1a] dark:bg-[#121212]/80 dark:text-slate-300 dark:hover:border-slate-800 dark:hover:text-slate-100"
