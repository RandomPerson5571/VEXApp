...
const fieldClassName =
  "w-full rounded-lg border border-slate-900 bg-slate-950/80 px-3 py-2.5 text-xs font-semibold text-slate-200 outline-none transition placeholder:text-slate-600 focus:border-blue-500/40 focus:ring-1 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60";
...
export function InviteSettingsPanel({
  ...
  return (
    <div className="rounded-xl border border-slate-900/70 bg-slate-950/35 p-5">
      <div className="mb-4 flex items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-800/80 bg-slate-950/60">
          <CalendarClock className="h-4 w-4 text-slate-400" />
        </div>
        <div>
          <h3 className="text-xs font-bold text-slate-100">Link settings</h3>
